...
interface RegisterApi {
    ...
    suspend fun register(registerRequest: RegisterRequest): Response<WrappedResponse<RegisterResponse>>

    @POST("v1/users/activeAccount")
    suspend fun activeAccount(activeAccountRequest: ActiveAccountRequest): Response<WrappedResponse<UserResponse>>
